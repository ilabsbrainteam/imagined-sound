# Template config file for mne_bids_pipeline.
...
random_state: int | None = 15485863  # the millionth prime
"""
...
mf_st_duration: float | None = 10.0
"""
...
n_proj_eog: dict[str, float] = dict(n_mag=1, n_grad=1, n_eeg=0)
"""
Number of SSP vectors to create for EOG artifacts for each channel type.
"""

n_proj_ecg: dict[str, float] = dict(n_mag=1, n_grad=1, n_eeg=0)
"""
...
reject: dict[str, float] | Literal["autoreject_global", "autoreject_local"] | None = (
    None  # TODO look at epoched data first
)
"""
